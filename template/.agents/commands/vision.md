...
1. Read `internal/docs/project-vision.md` and summarize the 9-row workload matrix + roadmap in 5 lines.
2. Read `internal/docs/specs/index.md` to see which specs are `✅ Shipped` vs `🔜 Planned` for the requested slice.
