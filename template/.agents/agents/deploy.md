...
1. **Understand the kind and target first** — read `krewire.yaml` (`project.kind` among 8), `internal/docs/project-vision.md`, and the target env (staging/prod). Never invent deploy steps.
