# Krewire Guild — Documentation

Krewire Guild (`github.com/krewire/guild`) — AI agent template for all 8 kinds.
...
- [Specifications](./specs/index.md) — formal `github.com/krewire/guild` specs (`KWG-*`)
