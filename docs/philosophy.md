...
**AI-native constitution for the unified framework.** One install gives any Krewire project (any of 8 kinds) a set of agents/skills that already know the vision, the 8-kind detection, the full `krewire` matrix, and  specs.
